...
- **El Paso Critical Notices Alerting Service.** Automated scraper polling the Kinder Morgan El Paso EBB every five minutes, deduplicating events against persistent state, and pushing real-time Force Majeure and maintenance notices to the DXT trading team via Microsoft Teams webhook — reducing trading-team response time from hours to minutes.
